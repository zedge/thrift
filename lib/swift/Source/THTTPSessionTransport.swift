...
public class THTTPSessionTransportFactory: TAsyncTransportFactory {
  ...
  func taskWithRequest(_ request: URLRequest, completionHandler: (Data?, URLResponse?, NSError?) -> ()) throws -> URLSessionTask {
...
public class THTTPSessionTransport: TAsyncTransport {
  ...
  public func flush(_ completed: (TAsyncTransport, ErrorProtocol?) -> Void) {
  ...
  public func flush() throws {
    ...
    var internalError: ErrorProtocol?
