...
public class TSSLSocketTransport: TNSStreamTransport {
  ...
  func recoverFromTrustFailure(_ myTrust: SecTrust, lastTrustResult: SecTrustResultType) -> Bool {
    ...
    if trustTime - newTime != 0 {
      ...
      let success = withUnsafeMutablePointer(&tr) { trPtr -> Bool in
  ...
  public func stream(_ aStream: Stream, handle eventCode: Stream.Event) {
    ...
    case Stream.Event.hasSpaceAvailable:
      ...
      repeat {
        ...
        withUnsafeMutablePointer(&ppolicy) { ptr in
        ...
        let success = withUnsafeMutablePointer(&trustResult) { trustPtr -> Bool in
