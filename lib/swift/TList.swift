 ...
 * under the License.
 */
public typealias TList<T> = Array<T : TSerializable>

extension Array : TSerializable {
  ...
  public static func read(from proto: TProtocol) throws -> Array<Element> {
    throw TProtocolError(error: .unknown, message: "\(Element.self) does not conform to TSerializable")
    return []
  }
...
extension Array where Element: TSerializable {
  public static func read(from proto: TProtocol) throws -> Array<Element> {
...
func sertest<T: TSerializable>(value: T) {
...
//public struct TList<Element : TSerializable> : ArrayLiteralConvertible {
...
//  public mutating func replaceSubrange<C: Collection where C.Iterator.Element == Element>(_ subrange: Range<Index>, with newElements: C) {
