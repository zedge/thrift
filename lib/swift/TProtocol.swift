...
extension UInt8 {
  ...
  var data: Data {
    var mutable = self
    return withUnsafePointer(&mutable) {
...
extension UInt16 {
  init?(data: Data) {
    ...
    self = data.withUnsafeBytes { (ptr: UnsafePointer<UInt8>) -> UInt16 in
      return UnsafePointer<UInt16>(ptr).pointee
    }
  }
  ...
  var data: Data {
    var mutable = self
    return withUnsafePointer(&mutable) {
      return Data(bytes: UnsafePointer<UInt8>($0), count: 2)
    }
  }
}
...
extension UInt32 {
  ...
  var data: Data {
    var mutable = self
    return withUnsafePointer(&mutable) {
      return Data(bytes: UnsafePointer<UInt8>($0), count: 4)
    }
  }
}
...
extension UInt64 {
  ...
  var data: Data {
    var mutable = self
    return withUnsafePointer(&mutable) {
      return Data(bytes: UnsafePointer<UInt8>($0), count: 8)
    }
  }
}
...
extension Double {
  init?(data: Data) {
    ...
    self = data.withUnsafeBytes { (ptr: UnsafePointer<UInt8>) -> Double in
      return UnsafePointer<Double>(ptr).pointee
    }
  }
...
extension Int8 {
  init?(data: Data) {
    ...
    self = data.withUnsafeBytes { (ptr: UnsafePointer<UInt8>) -> Int8 in
      return UnsafePointer<Int8>(ptr).pointee
    }
  }
  ...
  var data: Data {
    var mutable = self
    return withUnsafePointer(&mutable) {
      return Data(bytes: UnsafePointer<UInt8>($0), count: 1)
    }
  }
}
...
extension Int16 {
  init?(data: Data) {
    ...
    self = data.withUnsafeBytes { (ptr: UnsafePointer<UInt8>) -> Int16 in
      return UnsafePointer<Int16>(ptr).pointee
    }
  }
...
extension Int32 {
  init?(data: Data) {
    ...
    self = data.withUnsafeBytes { (ptr: UnsafePointer<UInt8>) -> Int32 in
      return UnsafePointer<Int32>(ptr).pointee
    }
  }
...
extension Int64 {
  init?(data: Data) {
    ...
    self = data.withUnsafeBytes { (ptr: UnsafePointer<UInt8>) -> Int64 in
      return UnsafePointer<Int64>(ptr).pointee
    }
  }
